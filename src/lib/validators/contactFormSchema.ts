...
export const contactFormSchema = z.object({
  name: z.string().min(3, { message: "Nama lengkap minimal 3 karakter." }).max(100),
  ...
  subject: z.string().min(5, { message: "Subjek minimal 5 karakter." }).max(150),
  message: z.string().min(20, { message: "Pesan minimal 20 karakter." }).max(1000, { message: "Pesan maksimal 1000 karakter." }),
});
